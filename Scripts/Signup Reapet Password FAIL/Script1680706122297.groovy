...
Mobile.setText(findTestObject('Field/Password'), 'AkuCintaKamuSelamanya', 0)

Mobile.tap(findTestObject('Object Repository/Field/Repeat Password'), 0)

Mobile.setText(findTestObject('Field/Repeat Password'), 'Aku', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/Notif/Button'), 0)

Mobile.verifyElementText(findTestObject('Notif/View Reapet Password Error'), '')
